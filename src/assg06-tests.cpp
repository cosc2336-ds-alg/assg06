...
TEST_CASE("<fibonacci algorithms> operation counts of algorithms second set", "[task6]")
{
  ...
  // just about 40
  int c1 = 6; // number of operations needed when calculation occurs
  int c2 = 2; // number of operations needed when just looking up result in table
